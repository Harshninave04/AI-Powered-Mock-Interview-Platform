...
[Know more about the project](https://deepwiki.com/Harshninave04/AI-Powered-Mock-Interview-Platform)
## Description
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Harshninave04/AI-Powered-Mock-Interview-Platform
